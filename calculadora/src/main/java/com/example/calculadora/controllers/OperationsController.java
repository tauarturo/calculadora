...
public class OperationsController {
    ...
    @GetMapping("/suma")
    @ApiOperation("Suma de operandos")
    ...
    @GetMapping("/resta")
    @ApiOperation("Resta de operandos")
    public String getResta(@RequestParam("minuendo") @ApiParam(example = "3.2", required = true) String minuendo,
